          ...
          .row.g-0
            ...
            .col-xl-6.info-section
              .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
                ...
                p.descripcion.mb-4 Los lineamientos curriculares en preescolar establecen las bases para una educación inclusiva y equitativa, garantizando el desarrollo integral de los niños en Colombia. Los Estándares Básicos de Aprendizaje (DBA) orientan la enseñanza y evaluación de competencias clave como la comunicación, la resolución de problemas y la interacción social. La teoría de las inteligencias múltiples permite adaptar estrategias pedagógicas a las diversas formas de aprender. Finalmente, los estándares de aprendizaje estructuran el currículo preescolar, asegurando un proceso educativo coherente que promueve el crecimiento cognitivo, emocional y social de los niños.
